...
**Tranche 1 : LIVRÉE. Tranche 2 slices 1 (risques Géorisques) et 2 (prix DVF) : LIVRÉES.** Suite de la Tranche 2 :
- **Pente/exposition + services** (US-2.4/2.5) : RGE ALTI (pente, exposition) + OSM (services de proximité), nouveaux types `PENTE`/`SERVICES` sur le socle existant.
...
- **Documents attachés** (US-5.8, MinIO auto-hébergé).
