...
- **Pente/exposition + services** (US-2.4/2.5) : RGE ALTI (pente, exposition) + OSM (services de proximité), nouveaux types `PENTE`/`SERVICES` sur le socle existant. **Prochaine slice demandée par le porteur.**
